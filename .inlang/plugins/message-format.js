// Vendored from @inlang/plugin-message-format v4.4.0
// Source: https://cdn.jsdelivr.net/npm/@inlang/plugin-message-format@4.4.0/dist/index.js
// Vendored on 2026-06-20 to remove the build-time dependency on a live CDN fetch.
// To update: re-download the same path with a newer @<version> and replace this file.
